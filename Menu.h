...
void Menu::reportarCliente(){
	...
	//guardarEnArchivo("Arbol de Clientes.txt", baseDeDatos.reporteCliente());
}

void Menu::reportarMenu(){
	system("cls");
...
void Menu::reportarCantidadProducto(){
	system("cls");
